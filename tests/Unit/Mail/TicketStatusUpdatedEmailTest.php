...
class TicketStatusUpdatedEmailTest extends TestCase
{
    /** @test */
    public function it_contains_a_link_to_the_ticket_thread_page()
    {
        ...
        $email = new TicketStatusUpdatedMail($ticket);
    ...
    public function it_has_a_subject()
    {
        ...
        $this->assertEquals('Support Ticket Status Updated', $email->build()->subject);
    }
}
