                ...
                <div class="mt-4 md:mt-0 col-lg-5 offset-lg-3 col-md-6">
                    <div class="flex justify-end items-center">
                        ...
                        <form class="ml-4 w-80 relative" action="{{ route($resourceName . '.index') }}" method="GET">
                            <input type="text" name="search" id="search" class="pl-10 form-input w-full block" placeholder="Search..." value="{{ old('search', request('search')) }}" required autocomplete="search">
