                        ...
                        <div class="px-4 py-5 border-b border-gray-200 sm:px-6">
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <span class="relative inline-block px-3 py-1 text-xs font-semibold text-indigo-900 leading-tight">
                                ...
                                <div class="flex">
                                    <a role="button" href="{{ route('spaces.edit', $space) }}" class="btn btn-secondary p-2 mr-2">
                                        <svg class="h-5 w-5 hover:text-gray-700" viewBox="0 0 20 20" fill="currentColor">
                                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"/>
                                        </svg>
                                    </a>

                                    <button class="btn btn-secondary p-2" data-toggle="modal" data-target="#deleteModal{{ $space->uid }}">
                                        <svg class="h-5 w-5 hover:text-gray-700" viewBox="0 0 20 20" fill="currentColor">
