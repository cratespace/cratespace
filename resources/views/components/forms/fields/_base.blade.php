<label class="block">
    ...
    <input type="text" name="base" id="base" value="{{ old('base') ?? ($base ?? business('country')) }}" autocomplete="base" placeholder="Sri Lanka" class="form-input block w-full mt-1 @error('base') is-invalid @enderror">
</label>
