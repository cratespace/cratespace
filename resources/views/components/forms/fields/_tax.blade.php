<label for="tax" class="block">
    <span class="text-gray-700 text-sm font-semibold">Tax</span>
    ...
    <div class="mt-1 relative rounded-lg shadow-sm">
        ...
        <input id="tax" class="form-input block w-full pl-10 pr-12" placeholder="0.00" name="tax" value="{{ old('tax') ?? ($tax ?? null) }}" />
