...
Vue.component(
    "navbar-link",
    require("./Components/Navbars/NavbarLink").default
);
Vue.component("dropdown", require("./Components/Dropdowns/Dropdown").default);
Vue.component(
    "dropdown-link",
    require("./Components/Dropdowns/DropdownLink").default
);
Vue.component(
    "dropdown-divider",
    require("./Components/Dropdowns/DropdownDivider").default
);
Vue.component("app-section", require("./Components/Sections/Section").default);
Vue.component(
    "main-section",
    require("./Components/Sections/MainSection").default
);
Vue.component(
    "section-header",
    require("./Components/Sections/SectionHeader").default
);
Vue.component(
    "section-title",
    require("./Components/Sections/SectionTitle").default
);
Vue.component(
    "section-content",
    require("./Components/Sections/SectionContent").default
);
Vue.component(
    "section-border",
    require("./Components/Sections/SectionBorder").default
);
Vue.component(
    "section-footer",
    require("./Components/Sections/SectionFooter").default
);
...
Vue.component(
    "tfa-challenge",
    require("./Views/Auth/TwoFactorAuthenticationChallenge").default
);
Vue.component(
    "reset-password-request",
    require("./Views/Auth/ResetPasswordRequest").default
);
...
Vue.component(
    ...
    require("./Views/API/ApiTokenManagement").default
);
